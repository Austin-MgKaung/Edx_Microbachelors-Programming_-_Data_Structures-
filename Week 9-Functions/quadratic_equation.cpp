...
//Constant to represent type of solution to an equation 
...
//        2.outX1,outX2 - solutions to equation (output parameter)
...
// Assumptions : IF equation has no solution 
int linear (double a,double b,double &outX);

// This program solves a quadratic equation 
// Input from user : 3 real numbers,representing coefficients of a quadratic equations.
//  Output to user : The solutions of the equations if there are any or an appropirate message.
int main ()
{
    ...
    {
        case TWO_REAL_SOLUTIONS:    cout<<"Solutions : "<<x1<<" "<<x2<<endl;
                                    break;

        case  ONE_REAL_SOLUTION:    cout<<"One Solution : "<<x1<<endl;
                                    break;
                            
        case NO_REAL_SOLUTION:      cout<<"No real Solution "<<endl;
                                    break;

        case NO_SOLUTION:           cout<<"No Solutions "<<endl;
                                    break;
        
        case ALL_REALS:             cout<<"All numbers are solutions "<<endl;
                                    break;
